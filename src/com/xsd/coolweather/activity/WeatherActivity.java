...
public class WeatherActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_refresh_weather = (Button) findViewById(R.id.bt_refresh_weather);
		bt_switch_city = (Button) findViewById(R.id.bt_switch_city);

		bt_refresh_weather.setOnClickListener(this);
		bt_switch_city.setOnClickListener(this);
	...
	private void showWeather() {
		...
		tv_publish_text.setText("今天" + prefs.getString("publish_time", "")
				+ "发布");
